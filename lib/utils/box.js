    ...
    createWelcomeBox() {
        ...
        try {
            ...
            const content = [
                ...
                '',
                colors.text(cleanDescription),
                '',
                colors.text('Feito com ') + colors.danger('💚') + colors.text(' por ') + colors.primary.bold(this.appInfo.author2),
                '',
            ...
            // Fallback simples e limpo
            return this.createBox(
                [
                    colors.success.bold(`🚀 ${this.appInfo.name.toUpperCase()}`),
                    colors.highlight2(`🌱 v${this.appInfo.version}`),
                    '',
                    colors.text('CLI para Conversão de Moedas USD/BRL'),
                    '',
                    colors.text('Feito com ') + colors.danger('💚') + colors.text(' por ') + colors.primary.bold(this.appInfo.author2)
                ].join('\n'),
                {
